...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        terrain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isTerrain) {
                    ...
                    terrain.setImageDrawable(getResources().getDrawable(R.drawable.ic_google_earth_unselected));
                } else {
                    map.setMapType(GoogleMap.MAP_TYPE_HYBRID);
                    terrain.setImageDrawable(getResources().getDrawable(R.drawable.ic_google_earth_selected));
                }
                isTerrain ^= true;
            }
        });
    ...
    public void onMapLongClick(final LatLng latLng) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                remoteDataBaseHelper.addPlace(new MyPlace(name, latLng.latitude, latLng.longitude,
                        address, null, 0.0, 0));
                dialog.dismiss();
            }
        });
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            map.addMarker(new MarkerOptions()
                                    ...
                                    .title("You're here")
                                    .icon(getMarkerIcon("#5352ED"))).showInfoWindow();
    ...
    public void startSyncService() {
        ...
        PendingIntent alarmIntent = PendingIntent.getService(this, 1, intent, PendingIntent.FLAG_CANCEL_CURRENT);
